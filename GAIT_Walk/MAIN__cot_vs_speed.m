...
% Walking Test Gait                                 %
%---------------------------------------------------%
% MAIN_Walk  --  CoT vs Speed
%
% This script runs a set of trajectory optimization problems, looking at 
% how cost of transport (energy use) for walking changes as a function of
% walking speed.
%
% This code is experimental research code
%
